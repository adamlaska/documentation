...
By default, Prysm uses TCP/13000 and UDP/12000. Remove those two rules and replace them with the appropriate port forwarding for the client you are switching to. The process will be very similar to the steps laid out [here.](/manage-connections/configure-ports-and-firewalls.md#configure-your-router)
