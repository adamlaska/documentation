...
The following best practices will help minimize the risk of [slashing](/learn/concepts/slashing.mdx) while migrating between clients:
...
- [Prysm Quickstart](/install-prysm/install-with-script.mdx)
