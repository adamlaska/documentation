...
This guidance is targeted at users who are already comfortable with Bazel and staking. See our [Quickstart](/install-prysm/install-with-script.mdx) for beginner-friendly installation instructions.
...
* All specified dependencies for building with Bazel [here](/install-prysm/install-with-bazel.mdx#dependencies)
