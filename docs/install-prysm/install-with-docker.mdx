...
This guidance is targeted at users who are already comfortable with Docker. See our [Quickstart](/install-prysm/install-with-script.mdx) for beginner-friendly installation instructions.
...
If you're not already running an execution node, refer to our [Quickstart](/install-prysm/install-with-script.mdx) for beginner-friendly execution node installation instructions.
...
This tells your Docker container to "listen" for connections from outside of your container, allowing you (and other services) to reach your RPC endpoint(s). See [Configure ports and firewalls](/manage-connections/configure-ports-and-firewalls.mdx) for more information.
