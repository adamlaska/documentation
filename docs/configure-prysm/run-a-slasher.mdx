...
This section provides instructions on how to run [slasher](https://github.com/OffchainLabs/prysm/tree/develop/beacon-chain/slasher) as an **optional** process to report slashable offenses on Ethereum proof-of-stake.  If slasher detects a slashable offense, proof is sent to the [beacon-chain node](/learn/dev-concepts/prysm-beacon-node.mdx) for inclusion in a block.  [Validators](/learn/dev-concepts/prysm-validator-client.mdx) earn a small whistleblower reward for including this proof into a block.  
