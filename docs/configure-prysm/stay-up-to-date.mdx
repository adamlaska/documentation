...
* [Using the Prysm installation script (Recommended)](/install-prysm/install-with-script.mdx)
* [Using Docker](/install-prysm/install-with-docker.mdx)
* [Building from source with Bazel (Advanced)](/install-prysm/install-with-bazel.mdx)
