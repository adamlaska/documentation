...
- [Installation Options](/install-prysm/install-with-script.mdx) - Different ways to install Prysm
- [FAQ](/faq) - Frequently asked questions
- [Technical Documentation](/learn/dev-concepts/prysm-beacon-node.mdx) - Deep dive into how Prysm works
...
Need more help? Join our [Discord community](https://discord.gg/qEZK94mFXP) for support.
