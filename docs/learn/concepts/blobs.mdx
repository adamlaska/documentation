...
- `--partial-data-columns`: Enables the Partial Columns feature for Fulu, which helps reduce your node's bandwidth usage. This feature is **disabled by default**. To learn more about how partial columns save bandwidth and how the feature works, see [this write-up](./partial-columns.mdx).
