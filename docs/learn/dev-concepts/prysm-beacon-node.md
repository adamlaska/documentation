...
## Blockchain service
The blockchain service is arguably the most important part of the project, as it enables the network to reach consensus on the protocol's state. It is responsible for handling the lifecycle of blocks, and applying the [fork choice rule](/terminology.mdx#fork-choice-rule) and state transition function provided by the [core package](#core-package) to advance the beacon chain.
