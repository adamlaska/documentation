...
* [Finding a **private IP**](/manage-connections/configure-ports-and-firewalls.mdx#determine-your-ip-addresses)
* [Finding a **public IP**](/manage-connections/configure-ports-and-firewalls.mdx#determine-your-ip-addresses)

:::info

In case of public IPs, [port forwarding](/manage-connections/configure-ports-and-firewalls.mdx#configure-your-router) may need to be configured.
