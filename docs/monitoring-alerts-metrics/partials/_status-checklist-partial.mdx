    ...
    <div className='checklist'>
        ...
        <div className='task'>
            ...
            <div className='guidance-container'>
                ...
                <p>Prysm will output an error if you attempt to provide an invalid Ethereum wallet address as a fee recipient address. You'll see warnings if a fee recipient address hasn't been provided. See [Configure Fee Recipient](/configure-prysm/configure-fee-recipient.mdx) for more information.</p>
            </div>
        </div>
        <div className='task'>
